...
int index_for_while = 0; do {pri.nt("wtf"); index_for_while++;} while (index_for_while < 4);
...
String[] lil = new String[4];
lil[0] = "teerer"; lil[1] = "gfgdhdhd"; lil[2] = "werwerwerwe"; lil[3] = "wegsdnrtjrt";
for(int i = 0; i < lil.length; i++){pri.n(lil[i]); pri.n(" ");} pri.nt("");
